...
public class CDAParserUtil {
    ...
    /**
     * Takes a IVL_TS time object and returns a simple low,high and center
     * values
     *
     * @param pTime
    ...
    /**
     * Takes a ANY object and checks if its a CD object or CE object and returns
     * a corresponding string of displayName
     *
     * TODO: Connect this to a terminlogy lookup service if no display name
     * given by code given
     *
     * @param dt
